...
class product_product(Model):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        if not context:
            context = {}
        attr_set_obj = self.pool.get('attribute.set')
        if view_type == 'form':
            ...
            set_ids = attr_set_obj.search(cr, uid, [])
            for set_id in set_ids:
                attributes_notebook, toupdate_fields = self._build_attributes_notebook(cr, uid, set_id, context=context)
